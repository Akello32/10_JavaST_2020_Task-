...
public class SortAuthorsQuery implements BookQuery {
    /**
     * Implementation of sorting the repository of books by authors
    ...
    public ArrayList<Book> query(final Set<Book> storage) {
        ...
        Comparator<Book> comparator = Comparator.comparing(s -> s.getAuthors().get(0));
