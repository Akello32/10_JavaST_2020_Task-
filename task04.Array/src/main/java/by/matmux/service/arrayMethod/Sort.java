...
public class Sort {
    public void shuttleSort(final Array arr) {
    ...
    public void quickSort(final Array arr, final int leftBorder, final int rightBorder) {
        int left = leftBorder;
    ...
    public void shellSort(final Array arr) {
